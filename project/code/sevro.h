...
#define SERVO_DUTY_MID   4530 
#define SERVO_DUTY_MIN   4040   //向右
#define SERVO_DUTY_MAX   4930   //向左 
#define SERVO_CENTER 4530u
#define MAX_TURN  430     //(((SERVO_DUTY_MAX)-(SERVO_DUTY_MIN))>>1)
